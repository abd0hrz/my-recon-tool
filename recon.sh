...
then
        ...
        then
                ...
                sublist3r -d $1 | grep ".$1"  >> Recon/$1/tmp_for_subs.txt;
        else
...
#--------------------------------------Get Live Subdomains-------------------------------
        ...
        cat Recon/$1/tmp_for_subs.txt | httpx -silent -ports 80,443,8080,8443,9443,8888,3000,81,30001,9000,10000 | cut -d '/' -f 3 | sort -u >> Recon/$1/live-subs.txt;
